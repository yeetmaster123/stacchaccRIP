...
enum ImGuiColorEditFlags_
{
    ...
    // Internals/Masks
	ImGuiColorEditFlags__theshits		= ImGuiColorEditFlags_AlphaBar | ImGuiColorEditFlags_NoInputs| ImGuiColorEditFlags_AlphaPreview,
    ImGuiColorEditFlags__InputsMask     = ImGuiColorEditFlags_RGB|ImGuiColorEditFlags_HSV|ImGuiColorEditFlags_HEX,
    ImGuiColorEditFlags__DataTypeMask   = ImGuiColorEditFlags_Uint8|ImGuiColorEditFlags_Float,
    ImGuiColorEditFlags__PickerMask     = ImGuiColorEditFlags_PickerHueWheel|ImGuiColorEditFlags_PickerHueBar,
    ImGuiColorEditFlags__OptionsDefault = ImGuiColorEditFlags_Uint8|ImGuiColorEditFlags_RGB|ImGuiColorEditFlags_PickerHueBar|ImGuiColorEditFlags_NoInputs|ImGuiColorEditFlags__PickerMask|ImGuiColorEditFlags_AlphaBar //from nnware - shits XD   // Change application default using SetColorEditOptions()
};
